          ...
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className="text-sm text-black/70">
                Iniciado: {formatters.formatDateTimeShort(turnoActual.createdAt)}
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {formatters.formatDateTimeShort(turno.createdAt)}
                        {turno.horaInicio && (
                          <span className="ml-1 font-semibold text-black">({turno.horaInicio})</span>
                        )}
                        {' - '}
                        {formatters.formatDateTimeShort(turno.updatedAt)}
                        {turno.horaCierre && (
