...
const BEEZERO_HEADERS = [
  ...
  'Bateria Cierre', 'Apertura Caja (Bs)', 'Pagos QR (Bs)', 'Cierre Caja (Bs)', 'ID Gastos', 'Total Gastos (Bs)',
...
function buildTurnoItem(data) {
  ...
  return {
    ...
    pagosQR: data.pagosQR != null ? String(data.pagosQR) : '',
